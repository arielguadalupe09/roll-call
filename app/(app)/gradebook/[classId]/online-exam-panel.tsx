  ...
  async function handleAdd(e: React.FormEvent) {
    ...
    if (questionsFile) {
      ...
      if (!res.ok || !parseData) {
        ...
        router.push(`/exams/${classId}/${newExam.id}`);
        return;
      }
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  <Button href={`/exams/${classId}/${exam.id}`} variant="secondary" size="sm">
                    Edit questions →
                  </Button>
                  <Button href={`/exams/${classId}/${exam.id}/preview`} variant="secondary" size="sm">
                    Preview →
                  </Button>
                  <Button href={`/exams/${classId}/${exam.id}/results`} variant="secondary" size="sm">
                    View results →
                  </Button>
                </div>
              </div>
